...
export default function PaymentPage() {
  ...
  const handleCopyAmount = () => {
    navigator.clipboard.writeText("7000")
    setCopiedAmount(true)
    setTimeout(() => setCopiedAmount(false), 2000)
  }

  const handleCopyAccountNumber = () => {
    navigator.clipboard.writeText("0424631279")
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-right">
            <div className="text-xl font-bold">NGN 7,000</div>
          ...
          <div className="bg-gray-100 p-4 space-y-6">
            <div>
              ...
              <div className="flex items-center justify-between">
                <p className="font-bold">NGN 7,000</p>
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                <p className="font-bold">0424631279</p>
                <button
