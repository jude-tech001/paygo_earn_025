...
export default function PaymentPage() {
  ...
  const handleCopyAccountNumber = () => {
    navigator.clipboard.writeText("5161493756")
        ...
        <div className="border border-gray-300 rounded-md overflow-hidden mb-6">
          <div className="bg-gray-100 p-4 space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                <p className="font-bold">5161493756</p>
                <button
            ...
            <div>
              ...
              <p className="font-bold">Stanbic-ibtc bank</p>
            </div>

            <div>
              <p className="text-gray-700 mb-1">Account Name</p>
              <p className="font-bold">moneey-app jude samuel</p>
            </div>
          </div>
